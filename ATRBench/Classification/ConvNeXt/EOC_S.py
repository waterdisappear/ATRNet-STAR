...
from model.ConvNeXt import convnext_1, ResNet_34
...
if __name__ == '__main__':
    ...
    test_set_1 = load_data(arg.data_path + 'test_30',data_transform)
    test_set_2 = load_data(arg.data_path + 'test_45',data_transform)
    test_set_3 = load_data(arg.data_path + 'test_60',data_transform)
