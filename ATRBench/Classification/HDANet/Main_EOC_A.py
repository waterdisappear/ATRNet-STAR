...
if __name__ == '__main__':
    ...
    test_set_1 = load_test(arg.data_path + 'test_60')
    test_set_2 = load_test(arg.data_path + 'test_120')
    test_set_3 = load_test(arg.data_path + 'test_180')
    test_set_4 = load_test(arg.data_path + 'test_240')
    test_set_5 = load_test(arg.data_path + 'test_300')
