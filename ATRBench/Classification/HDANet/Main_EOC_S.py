...
if __name__ == '__main__':
    ...
    test_set_1 = load_test(arg.data_path + 'test_urban')
    test_set_2 = load_test(arg.data_path + 'test_woodland')
    test_set_3 = load_test(arg.data_path + 'test_factory')
    ...
    torch.save(model.state_dict(), './Model/' + re.split('[/\\\]', arg.data_path)[-2] + '_new.pth')
    np.save('./results/' + re.split('[/\\\]', arg.data_path)[-2] + '_result_new.npy', history)
