...
def parameter_setting():
    ...
    parser.add_argument('--data_path', type=str, default="../地距/EOC_pol/",
...
if __name__ == '__main__':
    ...
    test_set_1 = load_data(arg.data_path + 'test_VV',data_transform)
    test_set_2 = load_data(arg.data_path + 'test_HV',data_transform)
    test_set_3 = load_data(arg.data_path + 'test_VH',data_transform)
    ...
    for k_F in tqdm(range(arg.fold)):
        ...
        for epoch in range(1, arg.epochs + 1):
            ...
            # accuracy = model_val(model, test_loader_3)
