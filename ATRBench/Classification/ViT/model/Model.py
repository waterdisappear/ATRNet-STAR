...
class ResNet_34(torch.nn.Module):
    def __init__(self, num_classes=3):
        ...
        #     if 'encoder.layers.encoder_layer_8' in name:
        #         p.requires_grad_(True)
        #     if 'encoder.layers.encoder_layer_9' in name:
        #         p.requires_grad_(True)
        #     if 'encoder.layers.encoder_layer_10' in name:
        #         p.requires_grad_(True)
        #     if 'encoder.layers.encoder_layer_11' in name:
        #         p.requires_grad_(True)
        # for _, p in model.encoder.ln.named_parameters():
